...
mcp_client = MCPClient.create_client(server_definition_file: File.join(File.dirname(__FILE__),
...
playwright_server = mcp_client.find_server('playwright')
filesystem_server = mcp_client.find_server('filesystem')
...
browser_tools = mcp_client.find_tools(/browser/)
...
mcp_client.call_tool('browser_tabs', { action: 'create' }, server: 'playwright')
...
mcp_client.call_tool('browser_navigate', { url: 'https://example.com' }, server: 'playwright')
...
mcp_client.call_tool('browser_take_screenshot', {}, server: 'playwright')
puts 'Screenshot captured successfully'

# Close browser
puts "\nClosing browser..."
# Using server parameter for disambiguation
mcp_client.call_tool('browser_close', {}, server: 'playwright')
puts 'Browser closed'
...
puts "mcp_client.call_tool('tool_name', params, server: 'server_name')"
